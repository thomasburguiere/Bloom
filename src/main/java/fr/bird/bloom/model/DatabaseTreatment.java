...
public class DatabaseTreatment {
	 ...
	 */
	public ArrayList<String> executeSQLcommand(String choiceStatement, String sql){
	...
	public ArrayList<String> deleteTable(String tableName, String UUIDcondition){
		ArrayList<String> messages = this.executeSQLcommand("executeUpdate", "DELETE FROM " + tableName + " WHERE UUID_=\"" + UUIDcondition +"\";");
		return messages;
	}
	...
	public ArrayList<String> dropTable(String tableName){
		ArrayList<String> messages = this.executeSQLcommand("executeUpdate", "DROP TABLE IF EXISTS " + tableName + ";");
		return messages;
	}
